...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, groups):
        ...
        self.image = pygame.image.load(IMAGES_PATH + f'{n}.png')
        self.image = pygame.transform.scale(self.image, (50, 50))
        x, y = random.randint(20, SCREEN_WIDTH-50), random.randint(-100, -50)
...
class Game:
    ...
    def collision(self):
        ...
        for expl in self.collisions_explosion:
            expl.animation()
            if expl.end_animation:
                self.collisions_explosion.remove(expl)
